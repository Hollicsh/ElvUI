...
------------  Missed phrases  ------------
L["Multiplier"] = "Коэффициент"
L["Backdrop Multiplier. Also used for the Transparent multiplier."] = "Коэффициент фона. Также используется для коэффициента прозрачности."
L["Zero is disabled."] = "Ноль отключен."
L["Cooldown & Duration"] = "Восстановление и длительность"
L["Default:"] = "По умолчанию:"
L["Allow Tag: PVP"] = "Разрешить тег: PvP"
L["Allow Tag: Faction"] = "Разрешить тег: Фракция"
L["Larger Scale"] = "Крупный масштаб"
L["Min Scale"] = "Минимальный масштаб"
L["Max Scale"] = "Максимальный масштаб"
L["Selected Scale"] = "Выбранный масштаб"
L["Player Larger Scale"] = "Игрок в крупном масштабе"
L["Non Selected Alpha"] = "Невыбранная прозрачность"
L["Selected Alpha"] = "Выбранная прозрачность"
L["Lock Friendly NPC Plates"] = "Блокировка индикаторов дружественных NPC"
L["Prevent Friendly NPC nameplates from being reset to enabled on login."] = "Предотвратить сброс индикаторов дружественных NPC в активное состояние при входе в систему."
L["Use Midnight Filters"] = "Использовать фильтры 'Полночи'"
L["SOUL_FRAGMENTS"] = "Фрагменты души"
L["EBON_MIGHT"] = "Черная мощь"
L["Filters: Midnight"] = "Фильтры: Полночь"
L["Filters: Legacy"] = "Фильтры: Устаревшие"
L["Player Auras"] = "Ауры игрока"
L["Raid Auras"] = "Ауры рейда"
L["Nameplate Auras"] = "Ауры индикаторов здоровья"
L["Defensive Auras"] = "Защитные ауры"
L["Alternative Bling"] = "Альтернативная вспышка"
L["Edge Color"] = "Цвет края"
L["Edge: Loss of Control"] = "Край: потеря контроля"
L["Swipe Color"] = "Цвет КД"
L["Swipe: Charge"] = "КД: перезарядка"
L["Edge: Charge"] = "Край: перезарядка"
L["Threshold"] = "Предел"
L["Minimum countdown duration (in milliseconds)."] = "Минимальная продолжительность обратного отсчета (в миллисекундах)."
L["Abbreviation threshold (in seconds)."] = "Предельное значение сокращения (в секундах)"
L["Reverse the cooldown animation."] = "Обратная анимация перезарядки."
L["The cooldown timer text."] = "Текст таймера перезарядки."
L["Hide Bling"] = "Скрыть вспышку"
L["Completion flash when the cooldown finishes."] = "Индикатор завершения загорится по окончании периода ожидания."
L["Boss Button"] = "Кнопка босса"
L["Worldboss"] = "Мировой босс"
L["Elite Boss"] = "Элитный босс"
L["Elite Mini"] = "Мини элитный"
L["Rare Elite"] = "Редкий элитный"
L["Rare"] = "Редкий"
L["Caster"] = "Кастер"
L["Melee"] = "Ближний бой"
L["Aura Bars"] = "Полосы аур"
L["Reset Text"] = "Сбросить текст"
L["Reset the Text Format to default."] = "Сбросить формат текста до значения по умолчанию."
L["Show On Item"] = "Показывать на элементе"
...
L["Tooltip gets anchored to bags when they are shown."] = "Подсказка прикрепляется к сумкам при их отображении."
L["Disabled"] = "Отключено"
L["Wave"] = "Волна"
L["Lean"] = "Наклон"
L["Dance"] = "Танец"
L["Salute"] = "Приветствие"
L["Talk"] = "Болтать"
L["Shy"] = "Стеснение"
L["Roar"] = "Рык"
L["Idle Animation"] = "Анимация бездействия"
L["Select the idle animation on the AFK screen."] = "Выбрать анимацию бездействия на экране AFK."
L["Anchor Type"] = "Тип крепления"
L["Block"] = "Блок"
L["Allow"] = "Позволять"
L["Auras cast by a boss unit."] = "Ауры, накладываемые боссами"
L["Auras which are classified as mounts."] = "Ауры, которые классифицируются как средства передвижения"
L["Auras which were from the pet unit."] = "Ауры, которые принадлежат юнитам питомцев"
L["Auras which were from another pet unit."] = "Ауры, которые принадлежат юнитам других питомцев"
L["Auras cast by yourself."] = "Ауры, наложенные Вами."
L["Auras with no duration."] = "Ауры без длительности."
L["Auras cast by anyone other than yourself."] = "Ауры, наложенные кем угодно, только не Вами."
L["Auras cast by the unit of the unitframe or nameplate (so on target frame it only shows auras cast by the target unit)."] = "Ауры, наложенные юнитом рамки или индикатора (например, на фрейме цели будут показаны только ауры, наложенные целью)."
L["Auras cast by anyone other than the unit of the unitframe or nameplate."] = "Ауры, наложенные любым юнитом, кроме юнита рамки или индикатора."
L["Auras you can either dispel or spellsteal."] = "Ауры, которые Вы можете развеять или украсть."
L["Auras you cannot dispel or spellsteal."] = "Ауры, которые нельзя развеять или украсть."
L["Auras cast by any NPC."] = "Ауры, наложенные НИПами."
L["Auras cast by any player-controlled unit (so no NPCs)."] = "Ауры, наложенные любым юнитом под контролем игрока (т.е. не НИПы)."
L["Auras that fall under the conditions to be a nameplate aura."] = "Ауры, которые попадают под условия, чтобы быть аурой на индикаторах."
L["Name Length"] = "Длина имени"
L["Target Class Color"] = "Цвет класса цели"
L["NoDuration"] = "Нет длительности"
L["Target Style"] = "Стиль цели"
L["Target Anchor"] = "Фиксатор цели"
L["Append to Cast Name"] = "Добавить к названию заклинания"
L["Custom Anchor"] = "Пользовательский фиксатор"
L["Target Text"] = "Текст цели"
...
L["BigWigs Spell Rename"] = "Переименование заклинания BigWigs"
L["Allows BigWigs to rename specific encounter spells on your castbar to something better to understand.\nExample: 'Impaling Eruption' becomes 'Frontal' and 'Twilight Massacre' becomes 'Dash'."] = "Позволяет BigWigs переименовывать определенные заклинания сражения на панели применения на более понятное имя.\nПример: «Пронзающее извержение» становится «Фронтальным», а «Сумеречная резня» становится «Рывком»."
...
L["Abbreviate Enchants"] = "Сократить чары"
...
L["Add an aura to the filter. Aura IDs can be acquired using the tooltip to find the correct ID."] = "Добавить ауру в фильтр. Идентификаторы ауры можно получить, используя всплывающую подсказку, чтобы найти правильный идентификатор."
L["Add an Item by dragging it, shift-clicking, or entering the Item ID onto this field."] = "Добавить предмет, перетащив его, удерживая клавишу Shift, или введя идентификатор предмета в это поле."
...
L["Add Spell ID or Name"] = "Добавить ID или название заклинания"
...
L["Always show Loot Specialization."] = "Всегда показывать добычу по специализации."
L["Always Show Player"] = "Всегда показывать игрока"
L["Always Show Realm"] = "Всегда отображать сервер"
L["Always Split Professions"] = "Всегда разделять профессии (сумки и банк)"
L["Always"] = "Всегда"
...
L["Auto Deposit Reagents"] = "Реагенты для автодепозита"
...
L["Backdrop By Value"] = "Фон по значению"
...
L["Backdrop Multiplier"] = "Коэффициент фона"
...
L["Blend"] = "Смешивание"
L["Blizzard Cooldown"] = "Перезарядки Blizzard"
L["Blizzard CVars"] = "Переменные Blizzard"
L["Blizzard Font Size"] = "Размер шрифта Blizzard"
L["Blizzard Nameplate"] = "Индикаторы здоровья Blizzard"
...
L["Change the scale of the Game Menu which shows up when you press ESC."] = "Изменить масштаб игрового меню, которое появляется при нажатии ESC."
...
L["Circle"] = "Круг"
L["Clamp nameplates to the top of the screen when outside of view."] = "Прикрепить индикаторы к верхней части экрана, когда они находятся вне поля зрения."
L["Clamp Nameplates"] = "Прикрепить индикаторы"
...
L["Custom Class Colors"] = "Цвета пользовательского класса"
...
L["DEBUG_DESC"] = "Отключите все аддоны (включая плагины), кроме ElvUI. Во время той же сессии можно нажать на эту кнопку, чтобы включить их снова."
...
L["Development Version"] = "Версия для разработчиков"
L["Dialog"] = "Диалог"
...
L["Display current mount the unit is riding."] = "Отображать маунт, на котором разъезжает игрок."
...
L["Display Mentorship status icon before names."] = "Отображать значок статуса наставничества перед именами персонажей."
...
L["Display Modified Rate Help Info"] = "Отображать скорость перезарядки, которая была изменена вследствие влияния эффектов и способностей"
L["Display Modified Rate"] = "Скорость перезарядки"
...
L["Display Tooltip on Raid Markers."] = "Отображать подсказки на рейдовых метках"
...
L["Display the item level and current specialization of the unit on modifier press."] = "Отображать уровень предметов и текущую специализацию юнита при нажатии клавиши-модификатора."
...
L["Display the unit name who interrupted a spell on the castbar. You should increase the Time to Hold to show properly."] = "Отображать имя прервавшего текущее заклинание на полосе. Для корректной работы нужно увеличить \"Время задержки\"."
...
L["Display Timerunning seasonal icon before names."] = "Отображать значок Путешествия во времени перед именами персонажей."
...
L["Displays item info on center of item."] = "Показывать информацию о предмете в центре предмета."
L["Displays item level on equippable items."] = "Показывать уровень предметов экипировки."
L["Displays the gender of players."] = "Показывать пол игроков"
...
L["Dont scale by Font Size as base."] = "Не масштабировать по размеру шрифта в качестве основы."
L["Down"] = "Вниз"
L["DRESSUP_FRAME"] = "Примерочная"
L["Dungeon (normal)"] = "Подземелье (обычное)"
L["Dungeon (heroic)"] = "Подземелье (героическое)"
L["Dungeon (mythic)"] = "Подземелье (мифическое)"
...
L["Enemy Spells"] = "Вражеские заклинания"
L["Enemy"] = "Враг"
...
L["Font Size as defined by Blizzard."] = "Размер шрифта, определенный Blizzard."
L["Font"] = "Шрифт"
L["Fonts"] = "Шрифты"
...
L["Force Reaction Color"] = "Цвет принудительной реакции"
...
L["Friendly Spells"] = "Дружественные заклинания"
...
L["Help"] = "Помощь"
L["Herbalism"] = "Травы"
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "Здесь Вы можете добавить предметы, которые хотите исключить из сортировки. Для удаления предмета из списка, кликните по его названию в списке."
...
L["Hide In Keystone"] = "Скрывать в М+"
...
L["Hides the yellow quest progress text and red error text at the top of the screen while in combat."] = "Скрывать жёлтый текст выполнения квеста и красный текст ошибок в верхней части экрана во время боя."
L["High"] = "Высокий"
...
L["Include Reagents"] = "Включить реагенты"
L["Include Warband"] = "Включить Отряды"
...
L["Limit the maximum, zero will disable the limit"] = "Ограничить максимальное значение, 0 отключит ограничение"
...
L["List of spells that will show from Blizzard's rotation helper."] = "Список заклинаний, которые будут отображаться в помощнике ротации Blizzard."
L["List of spells that will show when using Blizzard's assisted highlighting."] = "Список заклинаний, которые будут отображаться при использовании вспомогательной подсветки Blizzard."
...
L["Low"] = "Низкий"
L["Lower numbers mean a higher priority. Filters are processed in order from 1 to 100."] = "Меньшее значение = большему приоритету. Фильтры обрабатываются в порядке от 1 до 100."
...
L["Max Limit"] = "Максимальный предел"
...
L["Media"] = "Медиа"
L["Mentorship Icon"] = "Значок наставничества"
...
L["My Threat"] = "Моя угроза"
L["Mythic Keystone"] = "М+ ключ"
L["Mythic+ Best Run"] = "Лучшее прохождение М+"
L["Mythic+ Data"] = "М+ данные"
L["Mythic+ Score"] = "М+ рейтинг"
...
L["Objective Text"] = "Текст заданий"
...
L["Only Equipped"] = "Только надетая экипировка"
L["Only Friendly"] = "Только дружеские"
...
L["OPACITY"] = "Видимость"
L["OPTION_TOOLTIP_ACTION_BUTTON_USE_KEY_DOWN"] = "Способности будут задействоваться, когда пользователь нажимает, а не отпускает клавишу.\n\n|cffff3333Примечание:|r Использование макроса для клавиш модификации, соответствующего клавише действия «Поднять предмет», принудительно переключит эту клавишу на «Отпустить»."
...
L["Private (Character Settings)"] = "Личный (Настройки персонажа)"
...
L["PVP Sub Zone"] = "Субзона PvP"
L["PvP Text"] = "Текст PvP"
L["PVP Trinket"] = "PvP Аксессуар"
L["PVP Zone Text"] = "Текст зоны PvP"
...
L["Raid Warning"] = "Рейдовые предупреждения"
L["Raid"] = "Рейд"
...
L["Remove Spell ID or Name"] = "Удалить ID заклинания или название заклинания"
...
L["Resurrect Spells"] = "Заклинания воскрешения"
...
L["ROLE"] = "Роль"
L["Rotate"] = "Вращение"
L["Rotation Assistance"] = "Помощник ротации"
...
L["Saved Instances"] = "Сохраненные подземелья"
L["Say"] = "Сказать"
L["Scale"] = "Масштаб"
L["Scenario"] = "Сценарий"
...
L["Share Global"] = "Поделиться глобальным профилем"
L["Share Private"] = "Поделиться личным профилем"
...
L["Show ElvUI users and their version of ElvUI."] = "Показать тех, кто использует ElvUI и текущую версию аддона (красный цвет - устаревшая версия, зелёный - актуальная)."
L["Show ElvUI Users"] = "Показать пользователей ElvUI"
L["Show Empty Buttons"] = "Показывать пустые кнопки"
L["Show Enchants"] = "Показывать чанты"
...
L["Solo Color"] = "Цвет, когда Вы один"
...
L["Swap Modifier"] = "Заменить модификатор"
...
L["Talking Head Name"] = "Имя говорящей головы"
L["Talking Head Scale"] = "Масштаб говорящей головы"
L["Talking Head Text"] = "Текст говорящей головы"
...
L["The size of the Totem buttons."] = "Размер кнопок панели Тотема."
...
L["The width of the totem buttons."] = "Ширина кнопок панели Тотемов."
...
L["This option controls whether nameplates will follow the settings below."] = "Эта опция определяет, будут ли индикаторы здоровья соответствовать указанным ниже настройкам."
L["This option controls whether nameplates will follow the settings below.\n|cffFF3333Warning:|r This is an override to the Motion Type setting."] = "Эта опция определяет, будут ли индикаторы здоровья соответствовать указанным ниже настройкам.\n|cffFF3333Предупреждение:|r Это перезапишет настройку типа движения."
L["This option controls whether nameplates will follow the visibility settings below.\n|cffFF3333Warning:|r This will be overridden by the Enemy Combat Toggle."] = "Эта опция определяет, будут ли индикаторы здоровья соответствовать настройкам видимости, указанным ниже.\n|cffFF3333Предупреждение:|r Это будет перезаписано переключением режима боя с врагом."
L["This option controls whether nameplates will follow the visibility settings below.\n|cffFF3333Warning:|r This will be overridden by the Friendly Combat Toggle."] = "Эта опция определяет, будут ли индикаторы здоровья соответствовать настройкам видимости, указанным ниже.\n|cffFF3333Предупреждение:|r Это будет перезаписано переключением режима на дружественный бой."
...
L["This reset excludes AuraBar Colors, Aura Highlight, and Aura Indicators."] = "Этот сброс не включает цвет полос аур, подсветку аур и индикаторы аур."
...
L["Threat"] = "Угроза"
L["Threat similar to Blizzard, which displays your threat from the unit."] = "Угроза, аналогичная Blizzard, которая отображает вашу угрозу со стороны юнита."
...
L["Timerunning Icon"] = "Значок Путешествия во времени"
...
L["Use Blizzard Sell Junk"] = "Использовать Blizzard для продажи мусора"
...
L["Use Solo Color"] = "Использовать цвет, когда Вы один"
L["Use solo threat color when not in a group."] = "Использовать цвет угрозы, когда Вы не в группе."
...
L["Use the profile specific filter Aura Indicator (Pet) instead of the global filter Aura Indicator."] = "Использовать специальный фильтр \"Aura Indicator (Pet)\" вместо глобального фильтра Aura Indicator."
L["Use the profile specific filter Aura Indicator (Profile) instead of the global filter Aura Indicator."] = "Использовать специальный фильтр \"Aura Indicator (Profile)\" вместо глобального фильтра Aura Indicator."
...
L["Will display as additional power:"] = "Будет отображаться как дополнительный ресурс:"
...
L["World Sub Zone"] = "Мировая субзона"
L["World Zone Text"] = "Текст мировой зоны"
L["World"] = "Мир"
