...
L["Auras which should always be displayed."] = "Ауры, которые всегда должны быть видны."
L["List of important Dungeon and Raid debuffs. Includes affixes and utility on dead players like pending resurrection and available reincarnation."] = "Список важных дебаффов в подземельях и рейдах. Включает модификаторы и полезные эффекты для мёртвых игроков, такие как ожидание воскрешения и доступная реинкарнация."
L["List of important Dungeon and Raid buffs."] = "Список важных баффов для подземелий и рейдов."
L["Only important debuffs which influence your action priority. Recommended to be paired with 'Non Personal' set to 'Block'."] = "Только важные дебаффы, влияющие на приоритет Ваших действий. Рекомендуется использовать в сочетании с 'НЕ личными' в сочетании с 'Блоком'."
L["Only important CC debuffs like Polymorph, Hex, Stuns. Also includes important cc-like debuffs, for example Mind Soothe and Solar Beam."] = "Только важные дебаффы контроля, такие как Полиморф, Сглаз, Оглушение. Также включены важные дебаффы контроля, например, Успокоение разума и Столп солнечного света."
--- End missed phrases ---
...
L["%s is attempting to share the Private Profile (%s) with you. Would you like to accept the request?"] = "%s хочет передать Вам Приватный профиль (%s). Желаете ли Вы принять его?"
L["%s is attempting to share the Global Profile with you. Would you like to accept the request?"] = "%s хочет передать Вам Глобальный профиль. Желаете ли Вы принять его?"
...
L["Experience"] = "Опыт"
L["Download complete from %s, would you like to apply changes now?"] = "Загрузка завершена с %s. Желаете применить изменения сейчас?"
...
L["FPS Highest:"] = "Самый высокий FPS:"
L["FPS Lowest:"] = "Самый низкий FPS:"
L["Frame"] = "Рамка"
...
L["Private Raid Warning"] = "Личные предупреждения в рейде"
...
L["Rested:"] = "Бодрость:"
L["Restrict Pings"] = "Ограничить пинги"
 ...
 */guildlist|r ^minPlayers|r  -  Выводит отсортированный список гильдий из поисковика.
 */guildapply|r ^"message"|r  -  Применяется к пяти новым гильдиям с дополнительным сообщением.
