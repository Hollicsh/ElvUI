...
L["A raid marker feature is available by pressing Escape -> Keybinds. Scroll to the bottom -> ElvUI -> Raid Marker."] = "Использование рейдовых меток активируется через Escape -> Назначение клавиш. Прокрутите вниз -> ElvUI -> Рейдовые метки."
...
L["AddOn Memory:"] = "Аддоны занимают в памяти:"
L["Adjust the UI Scale to fit your screen."] = "Изменить масштаб интерфейса, чтобы подогнать его под Ваш экран."
L["Affix"] = "Аффикс"
L["All keybindings cleared for |cff00ff00%s|r."] = "Все привязки клавиш сброшены для |cff00ff00%s|r."
L["Alliance: "] = "Альянс: "
...
L["Auto Deposit"] = "Автоматический депозит"
...
L["Bags"] = "Сумки"
L["Bags (Grow Down)"] = "Сумки (направление вниз)"
L["Bags (Grow Up)"] = "Сумки (направление вверх)"
L["Bandwidth"] = "Канал"
L["Bank"] = "Банк"
L["Bank (Grow Down)"] = "Банк (направление вниз)"
L["Bank (Grow Up)"] = "Банк (направление вверх)"
L["Bar "] = "Панель "
L["Bars"] = "Полосы"
...
L["BNet Frame"] = "Оповещения Battle.net"
L["BoE"] = "ПпН"
L["BoP"] = "ПпП"
L["Boss"] = "Босс"
...
L["Download"] = "Загрузка"
L["Download complete from %s, would you like to apply changes now?"] = "Загрузка завершена из %s. Хотите применить изменения сейчас?"
L["Durability Frame"] = "Прочность"
L["Earned:"] = "Заработано:"
L["Elite"] = "Элитный"
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable it in the profiles tab."] = "ElvUI имеет функцию двойной специализации, которая позволяет Вам загружать различные профили на основе Вашей текущей специализации в режиме реального времени. Вы можете включить ее на вкладке 'Профили'."
L["ElvUI Installation"] = "Установка ElvUI"
L["ElvUI is five or more revisions out of date. You can download the newest version from tukui.org."] = "ElvUI устарел более чем на 5 версий. Вы можете скачать последнюю версию на tukui.org."
...
L["Error resetting UnitFrame."] = "Ошибка при сбросе юнит-фрейма."
...
L["Include Warband"] = "Включить Отряд"
...
L["No Mail"] = "Нет писем"
L["No Set Equipped"] = "Нет комплекта экипировки"
L["None"] = "Нет"
L["Nudge"] = "Сдвиг"
...
L["Please click the button below so you can setup variables and ReloadUI."] = "Пожалуйста, нажмите кнопку ниже, чтобы настроить переменные и перезагрузить интерфейс."
...
L["Private Raid Warning"] = "Приватные рейдовые предупреждения"
...
L["Quest Objective Frame"] = "Журнал задач"
L["Quest Timer Frame"] = "Таймер заданий"
L["Quests:"] = "Задания:"
...
L["Right Click to Open Menu"] = "ПКМ, чтобы открыть меню"
L["Right Click:"] = "ПКМ:"
L["Save"] = "Сохранить"
...
L["Shared Profile will select the default profile."] = "В режиме 'Общий профиль' будет выбран профиль по умолчанию."
L["Shift + Left Click to Toggle Bag"] = "Shift + ЛКМ, чтобы вкл./откл. сумки"
...
L["Spec"] = "Спек"
L["Spell Crit"] = "Критическое заклинание"
...
L["Time"] = "Время"
L["Time Alert Frame"] = "Предупреждение о времени"
...
L["Toggle Mover Mode"] = "Режим перемещения"
L["Toggle Tutorials"] = "Обучение"
...
L["Trigger"] = "Триггер"
L["UI Scale"] = "Скалирование интерфейса"
L["Unhittable:"] = "Неуязвимость:"
...
Параметры:
  ЛКМ - Возможность двигать рамку как угодно.
  ПКМ - Открыть раздел конфигурации.
 ...
 */guildlist|r ^minPlayers|r  -  Выводит отсортированный список гильдий из поля поиска.
 */guildapply|r ^"message"|r  -  Применяется к пяти лучшим новым гильдиям с необязательным сообщением.
